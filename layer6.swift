...
func main() {
    ...
    // let memory2 = ascii85Decode(encodedData: Array(encoded.utf8))
    // print(memory2)
...
func addInstruction(registers: inout Registers, memory: inout [UInt8], outputStream: OutputStream) throws {
    registers.pc += 1
    registers.a = (registers.a + registers.b) % 255
}
...
func subInstruction(registers: inout Registers, memory: inout [UInt8], outputStream: OutputStream) throws {
    registers.pc += 1
    registers.a = registers.b < registers.a ? registers.a - registers.b : 255 - (registers.b - registers.a)
}
